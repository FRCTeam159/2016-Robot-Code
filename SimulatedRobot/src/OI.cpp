...
OI::OI() {
    ...
    d_up->WhenPressed(new StepShooterAngle(1));
    d_down->WhenPressed(new StepShooterAngle(-1));

    d_right->ToggleWhenPressed(new ToggleGate());
    d_left->WhenPressed(new ShootBall());
